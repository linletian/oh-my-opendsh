...
- ✅ **dsh 0.1.5-rc.1 pin landed** — the 0.1.2-alpha.1 review ([中文](./docs/dsh-0.1.2-review_zh-CN.md)) was superseded before it was ever pinned (that tag was never published); the upgrade to 0.1.5-rc.1 is verified L1+L2 — see the [review](./docs/dsh-0.1.5-rc.1-review.md) / [upgrade record](./docs/dsh-0.1.5-rc.1-upgrade.md) and PRD §12
