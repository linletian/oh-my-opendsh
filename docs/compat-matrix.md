...
| dsh | omo | since | note |
|---|---|---|---|
| 0.1.2-rc.1 | 4.19.4 | 2026-09-05 | static review done (docs/dsh-0.1.2-review); runtime probe pending via scripts/compat-probe.sh; gates the D7 CI pin flip (PRD §12) |
