...
- [x] **Chinese twins for the 0.1.5-rc.1 records — DONE 2026-09-11.** [`dsh-0.1.5-rc.1-review_zh-CN.md`](./dsh-0.1.5-rc.1-review_zh-CN.md) and [`dsh-0.1.5-rc.1-upgrade_zh-CN.md`](./dsh-0.1.5-rc.1-upgrade_zh-CN.md) added; `docs/` is back to EN+zh pairs throughout (the pair was deliberately EN-only so the record landed with the change it describes).
